...
include "fungsi/pesan_kilat.php"; // mengaitkan dengan file-file yang diperlukan di-include, yaitu pesan_kilat.php dan koneksi.php
...
<head>
    ...
    <title>Aplikasi Kantor Dyah Nanda</title>
